<%@ Page Language="C#" MasterPageFile="~/Login.master" AutoEventWireup="true" CodeFile="registernewuser.aspx.cs" Inherits="registernewuser" Title="register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="body12" style="font-size:18px;margin-left:0px;">
    <table class="style17" >
        <tr>
            <td class="style19" colspan="2" 
                style="border-color: #000080; background-color: #000000; border-bottom-style: solid;">
       <h3 style="font-size:25px;"> REGISTER NEW USER</h3></td>
        </tr>
        <tr>
            <td class="style18">
                Name</td>
    ...
    <asp:TextBox ID="txtName" runat="server" Width="139px"></asp:TextBox>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                    ControlToValidate="txtName" ErrorMessage="Only a-z, A-Z are allowed" 
    ...
    <asp:TextBox ID="txtpassportNumber" runat="server" Width="139px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ...
                    ErrorMessage="Please Enter your ID  Number">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="style18">
    ...
    <asp:TextBox ID="txtUserName" runat="server" Width="139px"></asp:TextBox>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
                    ...
                    ErrorMessage="special charecters are not allowed" 
